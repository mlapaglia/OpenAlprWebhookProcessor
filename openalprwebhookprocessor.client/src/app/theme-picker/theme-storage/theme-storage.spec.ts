...
import { type DocsSiteTheme, ThemeStorage } from './theme-storage';
...
describe('ThemeStorage', () => {
  ...
  describe('storeTheme', () => {
    ...
    it('should overwrite existing stored theme', () => {
      const theme1: DocsSiteTheme = { name: 'theme1', primary: '#111', accent: '#222', displayName: 'Theme 1' };
      const theme2: DocsSiteTheme = { name: 'theme2', primary: '#333', accent: '#444', displayName: 'Theme 2' };
