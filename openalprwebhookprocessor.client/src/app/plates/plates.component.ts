...
export class PlatesComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public filterPlateNumberIsValid = true;
  ...
  private readonly searchSubscription = new Subscription();
  ...
  public getPlate(plateId: string) {
    ...
    this.searchSubscription.add(this.plateService.getPlate(plateId).subscribe((plateResponse) => {
      ...
      this.plates = [plateResponse.plate];
  ...
  public deletePlate(plateId = '', plateNumber = '') {
  ...
  public addToIgnoreList(plateNumber = '') {
  ...
  public addToAlertList(plateNumber = '') {
