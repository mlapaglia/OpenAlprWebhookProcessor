...
namespace Tests.Features.ImageRelay
{
    ...
    public class GetSnapshotQueryHandlerTests : TestBase
    {
        ...
        private IOptions<SnapshotRelayConfiguration> _options;
        ...
        public override void SetUp()
        {
            ...
            var config = new SnapshotRelayConfiguration
            {
            ...
            _handler = new GetSnapshotQueryHandler(
                UnitOfWork,
                _mockCameraFactory,
                _options);
        }
        ...
        {
            // Act & Assert
            FluentActions.Invoking(() => new GetSnapshotQueryHandler(null, _mockCameraFactory, _options))
        ...
        {
            // Act & Assert
            FluentActions.Invoking(() => new GetSnapshotQueryHandler(UnitOfWork, null, _options))
                .Should().Throw<ArgumentNullException>()
