...
namespace OpenAlprWebhookProcessor.Features.Webhooks.WebhookProcessor
{
    public class ImageRetrieverHostedService : BackgroundService
    {
        ...
        private async Task ProcessImageRequestsAsync(CancellationToken cancellationToken = default)
        {
        ...
        private async Task ProcessSingleImageRequest(string job, CancellationToken cancellationToken = default)
        {
        ...
        private async Task ProcessImageCompressionRequestsAsync(CancellationToken cancellationToken = default)
        {
        ...
        private async Task ProcessImageCompressionBatch(CancellationToken cancellationToken = default)
        {
            using var scope = _serviceProvider.CreateScope();
            var unitOfWork = scope.ServiceProvider.GetRequiredService<IUnitOfWork>();
