...
{
    /// <summary>
    /// Sends and receives messages to the OpenALPR agents
    /// </summary>
    public partial class OpenAlprWebsocketClient : IOpenAlprWebsocketClient
    {
        ...
        /// <summary>
        /// Since the OpenALPR agent sends messages in "chunks", responses must be collected until the
        /// message is complete. Supports receiving multiple messages at a time from the agent. 
        /// </summary>
