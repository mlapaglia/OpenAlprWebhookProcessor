...
namespace OpenAlprWebhookProcessor.Features.Webhooks.WebhookProcessor.OpenAlprAgentScraper
{
    public class OpenAlprAgentScraper : IOpenAlprAgentScraper
    {
        ...
        public async Task ScrapeAgentAsync(CancellationToken cancellationToken = default)
        {
        ...
        private async Task ScrapeDataForTimeRange(Agent agent, CancellationToken cancellationToken = default)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            OpenAlprWebhookProcessor.Features.Webhooks.WebhookProcessor.OpenAlprWebhook.Group group;
            try
            {
                timer.Reset();
                timer.Start();
                _logger.LogDebug("deserializing key: {Key}", metadata.Key);
                group = await JsonSerializer.DeserializeAsync<OpenAlprWebhookProcessor.Features.Webhooks.WebhookProcessor.OpenAlprWebhook.Group>(
        ...
        public async Task ScrapeAgentImagesAsync(CancellationToken cancellationToken = default)
        {
