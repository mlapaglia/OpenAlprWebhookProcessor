    ...
    public class LicensePlatesController : ControllerBase
    {
            ...
            CancellationToken cancellationToken)
        {
            var query = new SearchLicensePlatesQuery
            {
                ...
                IncludeIgnoredPlates = request.IncludeIgnoredPlates,
        ...
        [HttpPatch("{plateId:int}/platenumber")]
        public async Task<ActionResult> UpdatePlateNumber(
            Guid plateId,
            [FromBody] string plateNumber,
            CancellationToken cancellationToken)
        {
